...
output_dir = "Active Acoustics Review/Generated AAES RIRs Stimulus Test/";
...
function GenerateRIRs(condition_index, absorptions_dir, coords_dir, rotations_dir, directivities_dir, output_dir, sample_rate, bit_depth)
    ...
    current_config = RoomWithAAES(room_dims, ...
        ...
        sample_rate, ...
        bit_depth);
    current_config.GenerateSystemIRs(output_dir + "Room Condition "+condition_index+"/", true, true);
end